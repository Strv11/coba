...
try:ugen = open('user.txt','r').read().splitlines() #ganti ugent biar joss
except:ugen = ['Mozilla/5.0 (Linux; Android 8.1.0; MI 8 Build/OPM1.171019.011) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.86 Mobile Safari/537.36'] #ganti ugent BlackBerry Biar joss
try:ugen2 = open('user2.txt','r').read().splitlines()
except:ugen2 = ['Mozilla/5.0 (Linux; Android 8.1.0; MI 8 Build/OPM1.171019.011) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/69.0.3497.86 Mobile Safari/537.36'] #ugent blackberry
...
my_id = '100003732123231' #jgn di ubah om nnti ellor
...
def setting(self):
	...
	if hu in ['1','01']:
		...
		exit()
	print("""%s ●▬▬▬▬▬▬▬▬▬▬▬▬๑۩۩๑▬▬▬▬▬▬▬▬▬▬▬▬▬● """%(h))
	print("""%s \33[1;32m[01] B-Api (Kayak Koncol)"""%(h))
...
""")#line:49
    ...
    if OOO00O0OOO00OO00O in ['1','01']:#line:51
      print (f"{H}[{P}!{H}]{P} Send Message..");time .sleep (3 );os .system ('xdg-open https://wa.me/6285767354326?text=Bang+Jep+Ada+Lisensi+Trial');exit ()#line:52
